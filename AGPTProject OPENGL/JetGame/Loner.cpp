...
Loner::Loner(GLuint texture, SDL_Rect position, int textureWidth, int textureHeight)
    : texture(texture)
{
...
void Loner::Update(float deltaTime)
{
    ...
    // Update the Loner's position or other behaviors -- moves horizontally and fires every 2 seconds
